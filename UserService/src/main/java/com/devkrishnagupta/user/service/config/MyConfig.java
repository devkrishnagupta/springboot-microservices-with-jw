package com.devkrishnagupta.user.service.config;

import com.devkrishnagupta.user.service.config.intercepter.RestTemplateInterceptor;
...
//        return new RestTemplate();
    ...
    //de clear the bean of OAuth2AuthorizedClient manager
    @Bean
